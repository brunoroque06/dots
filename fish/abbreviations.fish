...
abbr python_setup 'python3 -m venv venv/; source venv/bin/activate.fish; pip install --upgrade pip; pip install -r requirements.txt; pip install black pylint'
...
abbr shell_scripts_lint 'find . -not -path "./.git/*" -type f -perm -u=x | xargs -t -I {} shellcheck -x {}'
